...
static void brawl_env_get_runtime (void) {
...
static unsigned int brawl_env_get_port (void) {
...
static void brawl_env_get_cerver_receive_buffer_size (void) {
...
static void brawl_env_get_cerver_th_threads (void) {
...
static void brawl_env_get_cerver_connection_queue (void) {
...
static unsigned int brawl_init_env (void) {

	unsigned int errors = 0;

	brawl_env_get_runtime ();

	errors |= brawl_env_get_port ();

	brawl_env_get_cerver_receive_buffer_size ();

	brawl_env_get_cerver_th_threads ();

	brawl_env_get_cerver_connection_queue ();
...
unsigned int brawl_init (void) {

	unsigned int errors = 0;

	if (!brawl_init_env ()) {
		errors |= brawl_service_init ();
	}
